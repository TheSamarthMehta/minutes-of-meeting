    ...
    <div className="min-h-screen bg-[#0a0a0a] flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 rounded-xl p-5">
        ...
        <div className="w-full max-w-md">
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <p className="text-sm text-gray-400 text-center">
              ...
              <Link href="/signup" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors border border-blue-500/30 px-4 py-2 rounded-lg hover:border-blue-400/50 inline-block">
                Create account
              </Link>
            </p>
          </form>
