        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Continue your productive meeting management journey with seamless access to all your data.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-700 bg-[#2a2a2a] text-blue-500 focus:ring-blue-500 focus:ring-offset-0" />
