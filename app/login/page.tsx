...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        "Logged in successfully! Session expires in 1 hour.",
        "success",
      );
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Continue your productive meeting management journey with seamless
          ...
          <div className="space-y-5">
            <div className="border-l-4 border-blue-500 pl-5">
              ...
              <p className="text-sm text-gray-400">
                Jump right back into your recent meetings and action items.
              </p>
            </div>
            ...
            <div className="border-l-4 border-indigo-500 pl-5">
              ...
              <p className="text-sm text-gray-400">
                Your data is encrypted end-to-end and stays protected.
              </p>
            </div>
            ...
            <div className="border-l-4 border-purple-500 pl-5">
              ...
              <p className="text-sm text-gray-400">
                Access from any device with instant sync across platforms.
              </p>
            </div>
          </div>

          <div className="bg-linear-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 rounded-xl p-5">
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div className="border-x border-blue-500/20">
                ...
                <div className="text-xs text-gray-400">Meetings Documented</div>
              </div>
              <div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-700 bg-[#2a2a2a] text-blue-500 focus:ring-blue-500 focus:ring-offset-0"
                />
            ...
            <div className="grid grid-cols-3 gap-3">
              <button
                ...
                className="flex items-center justify-center py-3 px-4 bg-[#2a2a2a] border border-gray-700 rounded-lg hover:border-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                type="button"
                disabled
                className="flex items-center justify-center py-3 px-4 bg-[#2a2a2a] border border-gray-700 rounded-lg opacity-40 cursor-not-allowed"
                title="GitHub login is disabled. Please use email/password."
              >
              ...
              <button
                ...
                disabled
                className="flex items-center justify-center py-3 px-4 bg-[#2a2a2a] border border-gray-700 rounded-lg opacity-40 cursor-not-allowed"
                title="GitLab login is disabled. Please use email/password."
              >
