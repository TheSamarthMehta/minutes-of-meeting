...
export default function SignUpPage() {
  ...
  return (
    <div className="h-screen bg-[#0a0a0a] flex overflow-hidden">
      {/* Left Side - Features */}
      <div className="hidden lg:flex lg:w-5/12 flex-col justify-between p-12 overflow-hidden fixed left-0 top-0 bottom-0">
      ...
      {/* Right Side - Form */}
      <div className="w-full lg:w-7/12 lg:ml-[41.666667%] flex items-start justify-center bg-[#1a1a1a] overflow-y-auto h-screen">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <button
                ...
                title="GitHub signup is disabled. Please use email/password form above."
              >
              ...
              <button
                ...
                disabled
                className="flex items-center justify-center py-3 px-4 bg-[#2a2a2a] border border-gray-700 rounded-lg opacity-40 cursor-not-allowed"
                title="GitLab signup is disabled. Please use email/password form above."
              >
