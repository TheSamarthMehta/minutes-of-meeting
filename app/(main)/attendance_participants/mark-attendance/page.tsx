      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Record participant attendance for meetings
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-gray-800 rounded-2xl p-6">
        ...
        <SearchableDropdown
          ...
          options={meetings.map((meeting) => ({
            value: meeting.id,
            label: `${meeting.title} - ${new Date(meeting.date).toLocaleDateString()} (${meeting.status})`,
          }))}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() =>
                            markAttendance(participant.id, "absent")
                          }
                          className={`px-4 py-2 rounded-lg transition-all flex items-center gap-2 ${
                            status === "absent"
